       ...
       <?php 
        ...
        elseif(isset($module_id))
        {
            ...
            if(count($modules_actionss) > 0)
              ...
              <tr class="odd gradeX">
                <td>
                  <input type="checkbox" class="checkboxes" name="user_id[]" value="<?php echo $row['user_id'];?>"/>
                </td>
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['user_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['user_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
             ...
             function deletee()
              {
                 var user_id = [];
                  ...
                  if(user_id ==''){
                    alert('SELECT ATLEAST ONE STAFF TO DELETE');
                  }else{
                 if(confirm('Are you sure ????'))
                {
                  
                  jQuery.post("Staff/delete",
                  {
                     user_id : user_id
                  },
