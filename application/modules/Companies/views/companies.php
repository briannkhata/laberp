       ...
       <?php 
        ...
        elseif(isset($module_id))
        {
            ...
            if(count($modules_actionss) > 0)
              ...
              <tr class="odd gradeX">
                <td>
                  <input type="checkbox" class="checkboxes" name="company_id[]" value="<?php echo $row['company_id'];?>"/>
                </td>
                ...
                <?php
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['company_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['company_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
             ...
             function deletee()
              {
                 var company_id = [];
                  ...
                  if(company_id ==''){
                    alert('SELECT ATLEAST COMPANY TO DELETE');
                  }else{
                 if(confirm('Are you sure ????'))
                {
                  
                  jQuery.post("Companies/delete",
                  {
