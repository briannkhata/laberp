								...
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group" style="padding-left:3%;">
											<a href="<?php echo base_url();?>Companies" class="btn btn-default">
										...
										<div class="panel-body">
										   ...
										   $this->db->order_by('cstaff_id','DESC');
										   ...
										   $query = $this->db->get('comp_staff')->result_array();
											foreach ($query as $row) {?>
								              <tr class="odd gradeX">
								                ...
								                <td>
								                <a href="<?php echo base_url();?>Companies/creatoo/<?php echo $row['cstaff_id'];?>/<?php echo $company_id;?>" class="btn btn-xs btn-info">
