        ...
        elseif(isset($module_id))
        {
           ...
           // ->join('users','user_module_actions.user_id = users.user_id')
            ...
            if(count($modules_actionss) > 0)
              ...
              <tr class="odd gradeX">
                <td>
                  <input type="checkbox" class="checkboxes" name="category_id[]" value="<?php echo $row['category_id'];?>"/>
                </td>
                ...
                <?php
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['category_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
                    ...
                    <i class="<?php echo $roww['icon'];?>"></i> 
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['category_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
             ...
             function deletee()
              {
                 var category_id = [];
                  jQuery('.checkboxes:checked').each(function(i,e){
                    category_id.push(jQuery(this).val());
                  });
                  if(category_id ==''){
                    alert('SELECT ATLEAST CATEGORY TO DELETE');
                  }else{
                 if(confirm('Are you sure ????'))
                {
                  
                  jQuery.post("Categories/delete",
                  {
