<div class="portlet box grey-cascade" style="border-top:1px solid #C3BFBF;">
        ...
        elseif(isset($module_id))
        {
           ...
           <?php if ($this->session->flashdata('message')) { ?>
              ...
              <tr class="odd gradeX">
                <td><input type="checkbox" class="checkboxes" name="clinic_id[]" value="<?php echo $row['clinic_id'];?>"/></td>
                ...
                <td>
                 <?php
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['clinic_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
                    ...
                    <i class="<?php echo $roww['icon'];?>"></i> 
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['clinic_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
             ...
             function deletee()
              {
                 var clinic_id = [];
                  jQuery('.checkboxes:checked').each(function(i,e){
                    clinic_id.push(jQuery(this).val());
                  });
                  if(clinic_id ==''){
                    alert('SELECT ATLEAST ONE CLINIC TO DELETE');
                  }else{
                 if(confirm('Are you sure ????'))
                {
                  
                  jQuery.post("Clinics/delete",
                  {
                     clinic_id : clinic_id
                  },
