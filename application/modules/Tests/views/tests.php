        ...
        elseif(isset($module_id))
        {
           ...
           <?php if ($this->session->flashdata('message')) { ?>
              ...
              <tr class="odd gradeX">
                ...
                <td><?php if (!empty($row['amount'])) {echo $currency.' '. number_format($row['amount'],2);}
                  else{
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['test_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['test_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
