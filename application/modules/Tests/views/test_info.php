					<div class="row">
						...
						<div class="portlet-title">
							<div class="caption">
							<?php $group_id =  $this->db->get_where('tests',array('test_id' =>$test_id))->row()->group_id;?>
							<?php echo $this->db->get_where('tests',array('test_id' =>$test_id))->row()->test_code;?> |
							<?php echo $this->db->get_where('tests',array('test_id' =>$test_id))->row()->test_name;?> |
							<?php echo number_format($this->db->get_where('tests',array('test_id' =>$test_id))->row()->amount,2);?> |
								...
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group" style="padding-left:3%;">
											<a href="<?php echo base_url();?>Tests" class="btn btn-default">
											<i class="fa  fa-chevron-left"></i> BACK 
											</a>
											<button class="btn red" onclick="deletee();">
											<i class="fa  fa-times"></i> DELETE
											</button>
											<a href="<?php echo base_url();?>Tests/creato/<?php echo $test_id;?>" class="btn green">
										...
										<div class="panel-body">
										   ...
										   $this->db->where('tests.test_id',$test_id);
										   ...
										   $query = $this->db->get('test_parameters')->result_array();
											foreach ($query as $row) {?>
								              <tr class="odd gradeX">
								                ...
								                <td>
								                <a href="<?php echo base_url();?>Tests/creatoo/<?php echo $row['test_parameter_id'];?>/<?php echo $test_id;?>" class="btn btn-xs btn-info">
