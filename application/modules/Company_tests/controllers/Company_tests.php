...
class Company_tests extends MY_Controller {
	    ...
	    function index(){
	    	if(!$this->M_Login->is_logged_in())
	  	 	redirect(base_url());
		    $data['page_title']  = 'Company_tests';
		    $data['description']  = 'Company_tests';
			$data['module_id'] = 'company_tests';
            //$data['usertype'] = $this->M_User_type->get_usertypes();
		    $data['content']   = 'Company_tests/company_tests';
		   ...
		   function comp_results(){
            ...
            //$data['usertype'] = $this->M_User_type->get_usertypes();
		    $data['content']   = 'Company_tests/comp_results';
			echo Modules::run('template/admin_v',$data);
		}
		...
		function add_company_test(){
			...
			redirect('Company_tests/new_testo/'.$data['company_id'].'/'.$data['count'].'/'.$data['request_date']);
		}
