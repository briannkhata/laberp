        ...
        elseif(isset($module_id))
        {
           ...
           // ->join('users','user_module_actions.user_id = users.user_id')
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['test_parameter_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
            ...
            ->where('user_type',$this->session->userdata('user_type'))
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['test_parameter_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
