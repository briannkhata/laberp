       ...
       <?php 
        ...
        elseif(isset($module_id))
        {
            ...
            if(count($modules_actionss) > 0)
              ...
              <tr class="odd gradeX">
                <td>
                  <input type="checkbox" class="checkboxes" name="ctest_id[]" value="<?php echo $row['ctest_id'];?>"/>
                </td>
                ...
                <?php
                      ...
                      <a href="<?php echo $sub_module_id.'/'.$roww['sub_module_action_id'].'/'.$row['ctest_id'];?>" class="<?php if ($roww['sub_module_action_id'] == 'create'){
                    ...
                    <i class="<?php echo $roww['icon'];?>"></i> 
                       ...
                       <a href="<?php echo $module_id.'/'.$roww9['action_id'].'/'.$row['ctest_id'];?>"  class="<?php if ($roww9['action_id'] == 'create') {
             ...
             function deletee()
              {
                 ...
                 if(confirm('Are you sure ????'))
                {
                  ...
                  jQuery.post("<?php echo base_url();?>New_test/delete",
                  {
                     ctest_id : ctest_id
                  },
