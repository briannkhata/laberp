                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="portlet-body form" style="background-color:white; height:1000px;">
													<form action="<?=base_url();?>New_test/add_company_test" method="post" style="background-color:white;">			
													<br>
													<div class="form-body" style="background-color:white;">
														...
														<div class="col-md-12">
															...
															<div class="col-md-12">
																<div class="form-group">
																	<a href="<?php echo base_url();?>New_test" style="margin-left:1%;" class="btn default"> BACK</a>
															...
															<div class="col-md-12">
																<div class="form-group">
																	<a href="<?php echo base_url();?>New_test" style="margin-left:%;" class="btn default"> BACK</a>
																</div>
															</div>
															<?php endif;?>
													</form>
