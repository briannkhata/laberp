...
<div class="logo">
  <a href="#">
  <!--img src="<?php echo base_url();?>assets/pos_icon.png" alt="" style="width:100px;height:100px;"-->
  </a>
</div>
<!-- END LOGO -->
...
<div class="content">                 
  ...
  <!-- BEGIN LOGIN FORM -->
  <form class="login-form" action="<?php echo base_url();?>Login/signin" method="post">
    <h3 class="form-title text-center">LAB SOFTWARE</h3>
  <h6 class="form-title text-center">--PLEASE LOGIN--</h6>
    ...
    <div class="form-actions">
      ...
      <button type="submit" class="btn blue pull-left" style="width:100%;">
